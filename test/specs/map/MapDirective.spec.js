...
describe('ga_map_directive', function() {
  var map, elt, scope, parentScope, layer;
  var $timeout, $httpBackend, $compile, $window, $q, $rootScope, gaBrowserSniffer, gaLayers, gaOffline, gaPermalink, gaStyleFactory, gaDebounce, gaMApUtils;
