...
searchLocationTests = [
    ...
    },
    {
        ...
        'resultLocation': 'lon=7.[0-9]{5}&lat=47.[0-9]{5}&zoom=13'
    },
    {
        'searchText': u'bern',
        'resultTitle': u'Bern (BE)',
        'resultLocation': u'lon=7.[0-9]{5}&lat=46.[0-9]{5}&zoom=13'
    }
]
