...
<%def name="table_body(c, lang)">
  ...
  <tr><td class="cell-left">${_('tt_emission_nacht_tag_lre_t')}</td>          <td>${c['attributes']['lre_t'] or '-'}</td></tr>
  <tr><td class="cell-left">${_('tt_emission_nacht_tag_k1_t')}</td>          <td>${c['attributes']['k1_t'] or '-'}</td></tr>
