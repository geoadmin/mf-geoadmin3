...
<%def name="extended_info(c, lang)">
    ...
    <table class="table-with-border kernkraftwerke-extended">
        ...
        <tr><th class="cell-left">${_('tt_lubis_x1')}</th>                <td>${c['attributes']['toposhop_start_x'] or '-'}</td></tr>
        <tr><th class="cell-left">${_('tt_lubis_y1')}</th>                <td>${c['attributes']['toposhop_start_y'] or '-'}</td></tr>
        <tr><th class="cell-left">${_('tt_lubis_x2')}</th>                <td>${c['attributes']['toposhop_end_x'] or '-'}</td></tr>
        <tr><th class="cell-left">${_('tt_lubis_y2')}</th>                <td>${c['attributes']['toposhop_end_y'] or '-'}</td></tr>
