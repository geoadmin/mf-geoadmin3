...
%>
    <tr><td width="150">${_('tt_sachplan_planning_name')}</td>              <td>${c['attributes'][plname]}</td></tr>
...
%endif
    <tr><td width="150">${_('tt_sachplan_planning_ueberanlage')}</td>       <td>${c['attributes'][facname]}</td></tr>
</%def>
