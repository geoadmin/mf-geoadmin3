...
<%def name="table_body(c,lang)">
    ...
    <tr><td class="cell-left">${_('Datenstand')}</td><td>${c['attributes']['release'] or '-'}</td></tr>
	  <tr><td class="cell-left">${_('Datenbezug')}</td><td><a href="http://www.toposhop.admin.ch/shop/products/maps/national/digital/pixelWizardEntryPoint?wizardMap=Pixel50" target="_blank">${_('Toposhop')}</a></td></tr>
</%def>
