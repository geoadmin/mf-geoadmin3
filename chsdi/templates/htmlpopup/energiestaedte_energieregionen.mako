...
Within the scope of the SFOE’s “Energy-Region” support programme, in an initial phase these energy cities and the municipalities affiliated to the Energy City Association carried out regional energy accounting and created their own organisations for intermunicipal cooperation. In a second phase, based on the criteria arising from the existing local accounting data and an analysis of the identified potentials, projects attuned to the local circumstances are to be selected and subsequently implemented.
     </p></td>
    </tr>
    <th class="cell-meta">
      ${_('link')}
