...
%>
    <tr><td width="150">${_('tt_sachplan_facility_name')}</td>                  <td>${c['attributes'][facname]}</td></tr>
    ...
    <tr><td width="150">${_('tt_sachplan_beschreibung')}</td>                   <td>${c['attributes'][description_text] or '-'}</td></tr>
...
%endif
    <tr><td width="150">${_('tt_sachplan_facility_uberobjekt')}</td>            <td>${c['attributes'][objectname] or '-'}</td></tr>
</%def>
