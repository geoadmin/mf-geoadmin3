...
<br></br>
<u>Città e Comuni pionieri</u>: negli ultimi anni, singole città e Comuni hanno dato un'impronta determinante e hanno contribuito allo sviluppo dell'idea di una società a 2000 Watt attraverso misure innovatrici e lungimiranti. 
<br></br>
<u>Programma</u>: nell'ambito del programma di sostegno dell'UFE «Concetti 2000 Watt», in una prima fase queste città hanno elaborato bilanci e progetti sulla base dei criteri della società a 2000 Watt al fine di percorrere il proprio percorso di riduzione del consumo energetico. In una seconda fase, vengono scelti e attuati progetti adatti al luogo sulla base del bilancio locale vigente, dell'analisi del potenziale e della riduzione progressiva definita.
  ...
  % elif lang=='en' :
    <td class="cell-meta" colspan="2"><p align="justify">
The idea of a “2000-watt society” is a vision for a shared, just and attractive future. The concept focuses on the two central indicators, “energy demand” and “greenhouse gas emissions”. According to the defined vision, in the medium term each resident is entitled to a permanent energy consumption of 2000 watts and an annual level of CO<sup>2</sup> emissions of not more than 1 tonne. In the past few years, a large number of municipalities and cities have undertaken a commitment to these 2000-watt goals and incorporated them into their energy policy guidelines.
<br></br>
<u>Label</u>: The Energy City on the Path Towards a “2000-Watt Society” label is awarded to municipalities that pursue visionary overlying objectives in line with the 2,000-watt philosophy. The certificate is issued jointly by the Swiss Federal Office of Energy and the Energy City Association.
<br></br>
<u>Pioneering approach</u>: In the past few years, a number of cities and municipalities have signifi-cantly influenced and codetermined the development of the 2000-watt concept through their progressive actions and forward-looking approach.
<br></br>
...
<br></br>
<u>Pionier</u>: Einzelne Städte und Gemeinden haben die Entwicklung der 2000-Watt-Idee durch ihr fortschrittliches und vorausdenkendes Handeln in den letzten Jahren massgeblich mitgeprägt und mitgestaltet.
<br></br>
<u>Konzept</u>: Im Rahmen des BFE Unterstützungsprogramms „2000-Watt-Konzepte“ haben diese Energiestädte in einer ersten Phase nach Kriterien der 2000-Watt-Gesellschaft Bilanzierungen und Konzepte erstellt, um sich auf ihren individuellen Absenkpfad begeben zu können. In einer zweiten Phase werden folgend auf der Grundlage der bestehenden lokalen Bilanz, der Potenzialanalyse und des definierten Absenkpfades standortgerechte Projekte ausgewählt und umgesetzt.
    </p></td> 
    </tr>
    <th class="cell-meta">
      ${_('link')}
