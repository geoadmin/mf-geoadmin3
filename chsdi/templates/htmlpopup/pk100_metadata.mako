...
<%def name="table_body(c,lang)">
   ...
   <tr><td width="150">${_('Datenbezug')}</td><td><a href="http://www.toposhop.admin.ch/shop/products/maps/national/digital/pixelWizardEntryPoint?wizardMap=Pixel100" target="_blank">${_('Toposhop')}</a></td></tr>
</%def>
