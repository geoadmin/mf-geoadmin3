...
%>
    ...
    <tr><td width="150">${_('tt_ch.bfe.statistik-wasserkraftanlagen_hydropowerplantoperationalstatus_de')}</td> <td>${c['attributes'][hydropowerplantoperationalstatus] or '-'}</td></tr>
    <tr><td width="150">${_('tt_ch.bfe.statistik-wasserkraftanlagen_hydropowerplanttype')}</td>                 <td>${c['attributes'][hydropowerplanttype] or '-'}</td></tr>
