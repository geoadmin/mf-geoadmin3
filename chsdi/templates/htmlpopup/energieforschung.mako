...
%>
    <tr><td width="150" valign="top">${_('tt_ch.bfe.energieforschung_projekttitel')}</td>   <td>${c['attributes'][title] or '-'}</td></tr>
    <tr><td width="150" valign="top">${_('tt_ch.bfe.energieforschung_beschreibung')}</td>   <td>${c['attributes'][beschreibung] or '-'}</td></tr>
    <tr><td width="150" valign="top">${_('tt_ch.bfe.energieforschung_projektstatus')}</td>  <td>${c['attributes'][projektstatus] or '-'}</td></tr>
