...
<%def name="table_body(c, lang)">
    <tr><td class="cell-left">${_('tt_wrz_portal_name')}</td>           <td>${c['attributes']['wrz_name'] or '-'}</td></tr>
    <tr><td class="cell-left">${_('tt_wrz_portal_obj')}</td>            <td>${c['attributes']['wrz_obj'] or '-'}</td></tr>
