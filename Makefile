...
updateol: .build-artefacts/ol3 .build-artefacts/ol-requirements-installation.timestamp
	...
	cd .build-artefacts/ol3; git checkout twpayne/vector-api-kml; git fetch origin; git checkout twpayne/vector-api-kml; git merge --ff origin/twpayne/vector-api-kml; git show; cp ../../scripts/ga-ol3.exports src/ol/ga-ol3.exports; ../python-venv/bin/python build.py $(addprefix build/,$(OL_JS))
