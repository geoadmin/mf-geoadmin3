...
.PHONY: prod
prod: prd/ prd/lib/ prd/lib/build.js prd/style/app.css prd/index.html prd/mobile.html prd/info.json prd/img/ prd/style/font-awesome-3.2.1/font/ prd/locales/ prd/checker prd/robots.txt prd/geoadmin.appcache

.PHONY: dev
dev: src/deps.js src/style/app.css src/index.html src/mobile.html src/geoadmin.appcache
