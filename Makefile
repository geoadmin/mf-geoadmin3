...
updateol: .build-artefacts/ol3 .build-artefacts/ol-requirements-installation.timestamp
	...
	cd .build-artefacts/ol3; git checkout vector-api-kml2; git fetch origin; git checkout vector-api-kml2; git merge --ff origin/vector-api-kml2; git show; cp ../../scripts/ga-ol3.exports src/ol/ga-ol3.exports; ../python-venv/bin/python build.py $(addprefix build/,$(OL_JS))
