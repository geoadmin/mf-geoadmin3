...
updateol: .build-artefacts/ol3 .build-artefacts/ol-requirements-installation.timestamp
	...
	cd .build-artefacts/ol3; git checkout master; git fetch origin: git checkout event-properties; git merge --ff origin/event-properties; git show; git apply ../../scripts/IEEvents.patch; cp ../../scripts/ga-ol3.exports src/ol/ga-ol3.exports; ../python-venv/bin/python build.py $(addprefix build/,$(OL_JS))
	cd .build-artefacts/ol3; git apply -R ../../scripts/IEEvents.patch
...
.build-artefacts/ol3:
	git clone https://github.com/twpayne/ol3.git $@
