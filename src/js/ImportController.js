  ...
  module.controller('GaImportController', function($scope, $q, $document,
    ...
    $scope.options = {
      urls: [
        ...
        'http://bio.discomap.eea.europa.eu/arcgis/services/Ecosystem/Ecosystems/MapServer/WMSServer?request=GetCapabilities',
        'http://copernicus.discomap.eea.europa.eu/arcgis/services/Corine/CLC2012_WM/MapServer/WMSServer?request=GetCapabilities'
