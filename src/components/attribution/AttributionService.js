...
const gaAttributionService = angular.module('ga_attribution_service', [
  'ga_layers_service',
 ...
 */
gaAttributionService.provider('gaAttribution', function() {
...
export default gaAttributionService;
