...
var gaBackgroundSelectorDirective = angular.module('ga_backgroundselector_directive', [
  'ga_background_service',
  gaEventService,
  'pascalprecht.translate'
]);

gaBackgroundSelectorDirective.directive('gaBackgroundSelector', function(
    $window,
    $translate,
    $rootScope,
    gaBackground,
...
export default gaBackgroundSelectorDirective;
