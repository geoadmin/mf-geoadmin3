...
const MapDirective = angular.module('ga_map_directive', [
...
MapDirective.directive('gaCesiumInspector', function(gaPermalink) {
  return {
    restrict: 'A',
    scope: {
...
MapDirective.directive('gaCesium3dTilesInspector', function(gaPermalink) {
  return {
    restrict: 'A',
    scope: {
...
MapDirective.directive('gaMap', function($window, gaPermalink,
