...
var gaDrawDirective = angular.module('ga_draw_directive', [
 ...
 *
 */
gaDrawDirective.directive('gaDraw', function($translate, $rootScope, $timeout,
...
export default gaDrawDirective;
