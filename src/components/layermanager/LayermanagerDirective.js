...
var gaLayerManagerDirective = angular.module('ga_layermanager_directive', [
 ...
 */
gaLayerManagerDirective.filter('gaTimeLabel', function($translate) {
...
gaLayerManagerDirective.directive('gaLayermanager', function($compile, $timeout,
...
export default gaLayerManagerDirective;
