...
const gaContextPopupDirective = angular.module('ga_contextpopup_directive', [
  gaEventService,
...
gaContextPopupDirective.directive('gaContextPopup', function($q, $timeout, $window, $rootScope,
      gaBrowserSniffer, gaNetworkStatus, gaPermalink, gaWhat3Words, gaEvent,
      gaWindow, gaHeight, gaMeasure) {
  return {
    restrict: 'A',
    replace: true,
...
export default gaContextPopupDirective;
