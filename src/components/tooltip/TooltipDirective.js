...
const gaTooltipDirective = angular.module('ga_tooltip_directive', [
...
gaTooltipDirective.directive('gaTooltip', function($timeout, $http, $q,
        $translate, $sce, $rootScope, gaPopup, gaLayers, gaBrowserSniffer,
        gaMapClick, gaDebounce, gaPreviewFeatures, gaMapUtils, gaTopic,
        gaIdentify, gaPermalink, gaIFrameCom, gaUrlUtils, gaLang, gaSanitize,
        gaEvent, gaWindow, gaGlobalOptions) {
  var popupContent =
...
export default gaTooltipDirective;
